...
class LBOExcelTemplate:
    ...
    @staticmethod
    def _get_or_create_sheet(wb: openpyxl.Workbook, sheet_name: str, index: Optional[int] = None) -> openpyxl.worksheet.worksheet.Worksheet:
    ...
    @staticmethod
    def _create_title_header(ws: openpyxl.worksheet.worksheet.Worksheet, title: str, 
                            merge_range: str, row: int = 1, font_size: int = 16) -> None:
    ...
    @staticmethod
    def create_cover_page(wb: openpyxl.Workbook, company_name: str, assumptions: Dict) -> openpyxl.worksheet.worksheet.Worksheet:
    ...
    @staticmethod
    def _add_category_section(ws: openpyxl.worksheet.worksheet.Worksheet, category: str, items: List[tuple], row: int) -> int:
    ...
    @staticmethod
    def format_header_cell(cell: openpyxl.cell.cell.Cell, text: str, merge_range: Optional[str] = None) -> openpyxl.cell.cell.Cell:
